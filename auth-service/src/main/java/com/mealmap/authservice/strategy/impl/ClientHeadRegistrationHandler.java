...
@Component
public class ClientHeadRegistrationHandler extends UserRegistrationBaseHandler {
    @Autowired
    public ClientHeadRegistrationHandler(UserService userService, UserMapper userMapper) {
    ...
    public UserDto handle(UserRegisterDto registerDto) {
        ...
        UserRepresentation registeredUser =
                userService.createUser(registerDto, getSupportedUserRole(), UserDefaults.clientHeadStatus());
