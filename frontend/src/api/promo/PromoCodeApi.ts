...
export const PromoCodeApi = {
    ...
    createPromoCode: async (promoCodeDto: PromoCodeCreationDto): Promise<PromoCodeDto> => {
        const response = await ApiClient.post<PromoCodeDto>("/promo-codes", promoCodeDto);
        return response.data;
    },

    updatePromoCode: async (code: string, promoCodeDto: PromoCodeUpdatingDto): Promise<PromoCodeDto> => {
        const response = await ApiClient.put<PromoCodeDto>(`/promo-codes/${code}`, promoCodeDto);
        return response.data;
    },
};