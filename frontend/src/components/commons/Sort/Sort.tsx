...
const Sort = <T extends string>({
  ...
  return (
    <div className="flex items-center justify-center gap-2 text-green-600 hover:text-green-800 border border-green-600 hover:border-green-800 px-4 py-2 rounded-lg transition-colors">
