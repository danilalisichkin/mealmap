...
const PopupNotification: React.FC<PopupNotificationProps> = ({
  ...
  const getNotificationIcon = () => {
    switch (type) {
      case NotificationType.SUCCESS:
        return (
          <i className="fas fa-check-circle bg-green text-green-500 text-xl"></i>
        );
  ...
  return (
    <>
      {shouldRender && (
        <div
          className={`popup-notification rounded-lg ${
            ...
            <div className="flex items-start p-4">
              <div className="flex-shrink-0">
                <div
                  ...
                  style={{
                    backgroundColor: `${notificationStyle.backgroundColor}20`,
                  }}
                >
                  {getNotificationIcon()}
                </div>
              ...
              <div className="ml-3 flex-1 pt-0.5">
                <p
                  ...
                  style={{ color: notificationStyle.color }}
                >
                  {message}
                </p>
              </div>
