...
interface UserHealthOverviewTabProps {
  ...
  formattedWeightDifference: number;
  formattedDietGoalWeight: number;
  formattedDietStartWeight: number;
  formattedRemainingWeight: number;
  bmi: string;
  bmiLabel: string;
  age: number | string;
}
...
const UserHealthOverviewTab: React.FC<UserHealthOverviewTabProps> = ({
  ...
  formattedDietStartWeight,
  formattedRemainingWeight,
  bmi,
  bmiLabel,
  age,
}) => (
  <div id="overview-tab" className="tab-panel active">
    <div className="health-card bg-white rounded-lg shadow-sm p-4 mb-4">
      ...
      <div className="flex items-end">
        <span className="text-3xl font-bold text-gray-800" id="current-weight">
        ...
        {formattedWeightDifference !== 0 && (
          <span
            className={`ml-auto text-sm px-2 py-1 rounded-full ${
                formattedWeightDifference > 0 ? "text-red-500" : "text-green-500"
            }`}
    ...
    <div className="health-card bg-white rounded-lg shadow-sm p-4 mb-4">
      ...
      <div className="mb-3">
        <span className="text-xl font-bold text-gray-800" id="diet-type">
          {DIET_LABELS[diet.dietType]}
        </span>
        <span id="goal-weight text-gray-500 ml-2">
