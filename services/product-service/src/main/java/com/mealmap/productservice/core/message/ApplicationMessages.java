...
public final class ApplicationMessages {
    ...
    public static final String ALLERGEN_NOT_FOUND = "аллерген %s не найден";
    public static final String ALLERGEN_WITH_NAME_ALREADY_EXISTS = "аллерген с приведенным названием уже существует";
    public static final String ALLERGENS_NOT_FOUND = "аллергены %s не найдены";
}
